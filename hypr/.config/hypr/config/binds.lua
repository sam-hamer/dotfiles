...
hl.bind(hyperMod .. " + T",     hl.dsp.exec_cmd(launchPrefix .. TERMINAL))
hl.bind(hyperMod .. " + F",          hl.dsp.exec_cmd(launchPrefix .. FILE_MANAGER))
hl.bind(hyperMod .. " + C",          hl.dsp.exec_cmd(launchPrefix .. EDITOR))
hl.bind(hyperMod .. " + K",          hl.dsp.exec_cmd(launchPrefix .. CALCULATOR))
hl.bind("XF86Calculator",           hl.dsp.exec_cmd(launchPrefix .. CALCULATOR))
hl.bind(hyperMod .. " + B",          hl.dsp.exec_cmd(launchPrefix .. BROWSER))
hl.bind(hyperMod .. " + D",          hl.dsp.exec_cmd(launchPrefix .. "discord"))
hl.bind(hyperMod .. " + N",          hl.dsp.exec_cmd(launchPrefix .. "obsidian"))
hl.bind(hyperMod .. " + P",          hl.dsp.exec_cmd(launchPrefix .. "cider"))
hl.bind(hyperMod .. " + SLASH",          hl.dsp.exec_cmd(launchPrefix .. "proton-pass"))
hl.bind("CONTROL + SHIFT + Escape", hl.dsp.exec_cmd(launchPrefix .. TERMINAL .. " -e btop"))
hl.bind(hyperMod .. " + COMMA",          hl.dsp.exec_cmd(noctCall .. "settings-toggle"))
hl.bind(hyperMod .. " + X",          hl.dsp.exec_cmd(noctCall .. "panel-toggle control-center"))
hl.bind(mainMod .. " + Space",      hl.dsp.exec_cmd(noctCall .. "panel-toggle launcher"))
hl.bind(hyperMod .. " + period",     hl.dsp.exec_cmd(noctCall .. "panel-toggle launcher /emo"))
hl.bind(hyperMod .. " + L",          hl.dsp.exec_cmd(noctCall .. "session lock"))
...
hl.bind(hyperMod .. " + S",               hl.dsp.exec_cmd(noctCall .. "screenshot-region"))
...
-- hl.bind("CONTROL + Space", hl.dsp.pass({ window = "class:^(Handy)$" }))
hl.bind("CONTROL + Space", hl.dsp.exec_cmd("pkill -USR2 -x handy"))
